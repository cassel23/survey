                        ...
                        <div class="col-md-6">
                            ...
                            <div class="card-footer justify-content-center">
                                ...
                                <div class="col-4 text-center">
                                    ...
                                    <canvas style="width: 0px; height: 60px;" width="75" height="75"></canvas>
                                    ...
                                    <div class="col-4 text-center">
                                        ...
                                        <input type="text" class="knob" data-readonly="true" value="<?= $val['count_responses'] ?>" data-width="60" data-height="60" data-fgcolor="#39CCCC" readonly="readonly" style="width: 34px; height: 20px; position: absolute; vertical-align: middle; margin-top: 20px; margin-left: -47px; border: 0px none; background: none; font: bold 12px Arial; text-align: center; color: rgb(57, 204, 204); padding: 0px; appearance: none;"></div>
